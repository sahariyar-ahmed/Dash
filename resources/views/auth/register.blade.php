...
<head>
    ...
    <script src="{{ asset('dashboard') }}/assets/j s/config.js"></script>
</head>
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('register') }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control @error('password') is-invalid @enderror" name='password_confirmation' type="password"  id="password-confirm" placeholder="Enter your password" value="{{ old('password') }}">
                                @error('password')
                                    <span class="invalid-feedback text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
