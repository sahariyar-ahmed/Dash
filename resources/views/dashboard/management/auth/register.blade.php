        ...
        <div class="card">
            <div class="card-body">
                ...
                <form role="form" action="{{route('management.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-2">
                        <label for="inputPassword5" @error('role') is-invalid @enderror" class="col-sm-3 col-form-label">Role</label>
                        <div class="col-sm-9">
                    ...
                    <table class="table mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form id="hulkuser{{$manager->id}}" action="{{route('management.down',$manager->id)}}" method="POST">
                                        @csrf
                                        <div class="form-check form-switch">
                                            <input onchange="document.querySelector('#hulkuser{{$manager->id}}').submit()" class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" {{ $manager->role == $manager->role ? 'checked' : '' }}>
                                            <label class="form-check-label" for="flexSwitchCheckChecked">{{ $manager->role }}</label>
